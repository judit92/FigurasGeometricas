...
public class ProgramaPrincipal {
    public static void main(String[] args) {
        ...
        for(FiguraGeometrica figuraGeometrica : arrayList) // recorremos el array
        {
            ...
            totalArea=totalArea + areaActual; // suma todas las areas de todas las figuras

            if (figuraGeometrica instanceof Circumferencia)
            {
                Circumferencia circumferencia = (Circumferencia)figuraGeometrica; // cast permite trata la fig como circunferencia
        ...
        System.out.println("la media del area delas fig.geom. es = " + media);
